...
// Adicionei o Filter aqui no import!
  ...
  return (
    <MainLayout activeItem="produtos">
      <div className="p-6 max-w-6xl mx-auto">
        ...
        {/* Cabeçalho da Tela (Atualizado padrão Mercos) */}
        <div className="flex justify-between items-center mb-6">
          
          {/* Lado Esquerdo: Botão Cadastrar (substituiu o MEUS PRODUTOS) */}
          ...
          {/* Lado Direito: Pesquisa e Filtro */}
